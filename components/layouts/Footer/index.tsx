  ...
  return (
    <footer className="w-full shadow-top">
      ...
      <div className="flex items-center justify-center flex-col sm:justify-between sm:flex-row bg-[#101828] p-7 px-16">
        <span className="text-sm text-white">©2077, All rights reserved.</span>
        <div className="flex mt-6 space-x-4 sm:justify-center sm:mt-0 ">
          ...
          >
            <svg
              className="w-[1.25rem] h-[1.125rem] transition-all duration-500 text-white"
              viewBox="0 0 15 15"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
          ...
          >
            <svg
              className="w-[1rem] h-[1rem] transition-all duration-500 text-white"
              viewBox="0 0 13 12"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
          ...
          >
            <svg
              className="w-[1.25rem] h-[0.875rem] transition-all duration-500 text-white"
              viewBox="0 0 16 12"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
